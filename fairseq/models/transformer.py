...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        for layer in self.layers:
            x = layer(
                x, encoder_padding_mask, self_attn_mask=self.buffered_future_mask(x)
            )
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        self.layers.extend(
            [
                TransformerDecoderLayer(args, no_encoder_attn, first_layer=(i == 0))
    ...
    def forward(
        ...
        **unused
        ...
        x, extra, d = self.extract_features(
            prev_output_tokens, encoder_out, incremental_state, step=step
        )
