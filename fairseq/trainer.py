...
class Trainer(object):
    ...
    def init_meters(self, args):
        ...
        self.meters["latency_loss"] = AverageMeter()
    ...
    def train_step(self, samples, dummy_batch=False, raise_oom=False):
        ...
        try:
            ...
            if "latency_loss" in logging_output:
                self.meters["latency_loss"].update(
                    logging_output.get("latency_loss", 0), ntokens
                )
            # pdb.set_trace()
