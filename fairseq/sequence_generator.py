...
class SequenceGenerator(object):
    ...
    def generate(self, models, sample, prefix_tokens=None, bos_token=None, **kwargs):
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            lprobs, attn_weight, d = model.forward_decoder(
                tokens[:, : step + 1],
                encoder_outs,
...
class EnsembleModel(torch.nn.Module):
    ...
    @torch.no_grad()
    def forward_decoder(self, tokens, encoder_outs, temperature=1.0, step=None):
    ...
    def _decode_one(
        ...
        decoder_out = list(model.decoder(tokens, encoder_out, step=step))
